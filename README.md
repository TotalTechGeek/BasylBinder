...
A small, fast and efficient MVC Framework, built for speeding up development, in just about 4.01KB (minified + gzipped).
...
BasylBinder is a standalone web framework that currently clocks in at just about 4.01KB, and avoids all the hassle of larger MVC frameworks.
